...
export const translations: Record<string, any> = {
  vi: {
    ...
    fleet: {
      ...
      items: [
        { categoryId: "4-7", category: "Xe 4-7 chỗ", name: "Xe 7 chỗ", badge: "7 chỗ", description: "Xe gia đình, tiện nghi, phù hợp di chuyển nhóm nhỏ.", price: "Từ 800k/ngày", image: "/images/7.png", specs: [{ label: "7 ghế", icon: "seat" }, { label: "A/C", icon: "comfort" }, { label: "Hành lý vừa", icon: "storage" }] },
        { categoryId: "4-7", category: "Xe 4-7 chỗ", name: "Xe 4 chỗ", badge: "4 chỗ", description: "Xe 4 chỗ cao cấp, thoải mái cho gia đình và đối tác.", price: "Từ 900k/ngày", image: "/images/4.png", specs: [{ label: "4 ghế", icon: "seat" }, { label: "A/C", icon: "comfort" }, { label: "Khoang rộng", icon: "storage" }] },
        { categoryId: "4-7", category: "Xe 4-7 chỗ", name: "Xe 7 chỗ (Ảnh đính kèm)", badge: "7 chỗ", description: "Mẫu 7 chỗ tiện nghi (ảnh đính kèm).", price: "Từ 850k/ngày", image: "/images/7.webp", specs: [{ label: "7 ghế", icon: "seat" }, { label: "A/C", icon: "comfort" }, { label: "Hành lý vừa", icon: "storage" }] },
        ...
        { categoryId: "16", category: "Xe 16 chỗ", name: "Mercedes Sprinter", badge: "16 chỗ", description: "Xe ghế da, phù hợp hành trình dài và khách doanh nghiệp.", price: "Từ 1.500k/ngày", image: "/images/16-2.png", specs: [{ label: "16 ghế", icon: "seat" }, { label: "A/C", icon: "comfort" }, { label: "Tiện nghi cao", icon: "storage" }] },
        { categoryId: "29", category: "Xe 29 chỗ", name: "Hyundai County", badge: "29 chỗ", description: "Xe trung bình, phù hợp cho đoàn vừa và nhỏ.", price: "Từ 2.500k/ngày", image: "/images/29.png", specs: [{ label: "29 ghế", icon: "seat" }, { label: "A/C", icon: "comfort" }, { label: "Khoang lớn", icon: "storage" }] },
        { categoryId: "29", category: "Xe 29 chỗ", name: "Thaco Town", badge: "29 chỗ", description: "Xe phục vụ đoàn vừa, kinh tế và ổn định.", price: "Từ 2.300k/ngày", image: "/images/29-2.png", specs: [{ label: "29 ghế", icon: "seat" }, { label: "A/C", icon: "comfort" }, { label: "Khoang đồ vừa", icon: "storage" }] },
